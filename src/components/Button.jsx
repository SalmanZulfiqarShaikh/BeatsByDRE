...
function Button({ label, iconURL, targetId = 'home' }) {
  const handleClick = (e) => {
  ...
  return (
    <button
      ...
      className="flex justify-center items-center gap-2 px-7 py-4 border border-gray-700
                 font-poppins font-medium text-[16px] text-orange-400 cursor-pointer
                 transition-all duration-300 rounded-full text-lg text-center
